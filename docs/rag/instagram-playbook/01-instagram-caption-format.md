...
- Writing a single paragraph with no line breaks — hard to skim on mobile
- Using "like if you agree" or "tag a friend" — flagged as engagement bait by the 2026 Instagram algorithm
- Repeating the entire carousel in the caption — wastes space, reduces dwell time on slides
- Placing the CTA in the first line — wastes the hook slot; CTA belongs at the end
- Copying the same caption text to TikTok and LinkedIn without adaptation — each platform has different norms and truncation lengths

---

## Freshness Note

All sources are 2026 unless otherwise noted. The 125-character truncation figure is consistent across multiple 2026 sources and aligns with Instagram's mobile UI behavior.
